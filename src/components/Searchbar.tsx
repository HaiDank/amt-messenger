	...
	return (
		<>
			...
			<div className='relative w-full'>
				<input
					type='text'
					className='block w-full p-2 text-sm text-gray-900 bg-gray-200 bg-opacity-50 border border-gray-200 border-opacity-50 rounded-sm focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
